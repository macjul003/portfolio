...
date: "2026-02-22"
description: Why I decided to share my process, not just the polished outcomes.
---
...
## The polished portfolio problem
...
- **Design decisions** — the reasoning behind choices, not just the outcomes
- **Tools and process** — what I actually use day-to-day and why
- **Things I got wrong** — because that's where the interesting lessons live
